...
<title>{title}</title>
<link rel="icon" type="image/svg+xml" href="assets/pixel/favicon.svg?v=2">
<link rel="icon" type="image/png" sizes="48x48" href="assets/pixel/favicon-48.png?v=2">
<link rel="icon" type="image/png" sizes="32x32" href="assets/pixel/favicon.png?v=2">
<!-- iOS 主屏图标：补齐多档高分辨率尺寸，系统会自动挑最清晰的一张 -->
<link rel="apple-touch-icon" sizes="180x180" href="assets/pixel/apple-touch-icon.png?v=2">
<link rel="apple-touch-icon" sizes="152x152" href="assets/pixel/apple-touch-icon-152.png?v=2">
<link rel="apple-touch-icon" sizes="1024x1024" href="assets/pixel/icon-1024.png?v=2">
